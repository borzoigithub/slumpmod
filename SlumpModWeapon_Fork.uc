...
* Weapon: Fork.
*/
class SlumpModWeapon_Fork extends AOCWeapon_Fork;
...
DefaultProperties
{
	...
	AttachmentClass=class'SlumpModWeaponAttachment_Fork'
	...
	TransitionAnimations(1)=(AnimationName=3p_spear_stab02tostab01,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.7,fBlendInTime=0.00,fBlendOutTime=0.00,bLastAnimation=false)
